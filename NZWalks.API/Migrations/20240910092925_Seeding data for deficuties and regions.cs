...
{
    /// <inheritdoc />
    public partial class Seedingdatafordeficutiesandregions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("5168d4bf-a503-467c-85a1-683730e6dcb2"), "Medium" },
                    { new Guid("933f35db-8666-41a4-b59a-3cede3575908"), "Easy" },
                    { new Guid("bab6e0db-6891-43b8-a884-8e2d34b98517"), "Hard" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "difficulties",
                keyColumn: "Id",
                keyValue: new Guid("5168d4bf-a503-467c-85a1-683730e6dcb2"));

            migrationBuilder.DeleteData(
                table: "difficulties",
                keyColumn: "Id",
                keyValue: new Guid("933f35db-8666-41a4-b59a-3cede3575908"));

            migrationBuilder.DeleteData(
                table: "difficulties",
                keyColumn: "Id",
                keyValue: new Guid("bab6e0db-6891-43b8-a884-8e2d34b98517"));
